...
use crate::cfg::{DEFAULT_FIELD_CONFIG_PATH, FIELD_CONFIGS_PATH};
...
use crate::{
    cfg::FARM_ENTITY_PLANS_PATH, environment::{
        ...
        camera::Camera,
        render::{render_coordinate_system, render_drag_points, render_field_config, render_grid, render_obstacles, render_visibility_graph},
    ...
    fn render_ui(&mut self, ui: &mut Ui) {
        ...
        ui.horizontal_top(|ui| {
            if ui.button("Add line").clicked() {
                self.field_config.configs.push(VariantFieldConfig::Line(LineFieldConfig::default()));
                self.field_config.recalc_id_color();
            }
            if ui.button("Add point").clicked() {
                self.field_config.configs.push(VariantFieldConfig::Point(PointFieldConfig::default()));
                self.field_config.recalc_id_color();
            }
        ...
        if needs_recalc { self.field_config.recalc_id_color(); }
