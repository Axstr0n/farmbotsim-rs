            ...
            egui::ComboBox::from_id_salt("ChargingStrategy")
                ...
                .show_ui(ui, |ui| {
                    if ui
                        .selectable_label(
                            matches!(
                                self.config.charging_strategy,
                                ChargingStrategy::CriticalOnly(_)
                            ),
                            "CriticalOnly",
                        )
                        .clicked()
                    ...
                    if ui
                        .selectable_label(
                            matches!(
                                self.config.charging_strategy,
                                ChargingStrategy::ThresholdWithLimit(_, _)
                            ),
                            "ThresholdWithLimit",
                        )
                        .clicked()
            ...
            egui::ComboBox::from_id_salt("ChooseStationStrategy")
                ...
                .show_ui(ui, |ui| {
                    if ui
                        .selectable_label(
                            matches!(
                                self.config.choose_station_strategy,
                                ChooseStationStrategy::Manhattan(_)
                            ),
                            "Manhattan",
                        )
                        .clicked()
