        ...
        ui.horizontal(|ui| {
            ...
            egui::ComboBox::from_id_salt("Type")
                ...
                .show_ui(ui, |ui| {
                    if ui
                        .selectable_label(
                            matches!(self.movement, Movement::RombaMovement(_)),
                            "RombaMovement",
                        )
                        .clicked()
                    {
        ...
        match &mut self.movement {
            Movement::RombaMovement(params) => {
                ...
                value_with_unit_selector_ui(
                    ...
                    "max_velocity",
                    "max_velocity",
                    &mut params.max_velocity.value,
                    &mut params.max_velocity.unit,
                    Some(0.0),
                    None,
                );
                ...
                value_with_unit_selector_ui(
                    ...
                    "max_angular_velocity",
                    &mut params.max_angular_velocity.value,
                    &mut params.max_angular_velocity.unit,
                    Some(0.0),
                    None,
                );
                ...
                value_with_unit_selector_ui(
                    ...
                    "wheel_distance",
                    "wheel_distance",
                    &mut params.wheel_distance.value,
                    &mut params.wheel_distance.unit,
                    Some(0.0),
                    None,
                );
                ...
                value_with_unit_selector_ui(
                    ...
                    "wheel_radius",
                    "wheel_radius",
                    &mut params.wheel_radius.value,
                    &mut params.wheel_radius.unit,
                    Some(0.0),
                    None,
                );
